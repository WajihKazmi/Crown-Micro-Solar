...
class PlantRepository {
  ...
  Future<bool> editPlant({
    ...
    final qp = <String, String>{
      ...
      'profit.unitProfit': (plant.unitProfit ?? 0).toString(),
      'profit.currency': plant.currency ?? 'USD',
      'profit.currencyCountry': plant.country ?? '',
      'profit.coal': (plant.coalSaved ?? 0).toString(),
      'profit.co2': (plant.co2Emission ?? 0).toString(),
      'profit.so2': (plant.so2Emission ?? 0).toString(),
