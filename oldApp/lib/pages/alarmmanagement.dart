...
class AlarmManagement extends StatefulWidget {
  String? PID;
  String? Plantname;
  String? SN;
  AlarmManagement({Key? key, this.SN, this.PID, this.Plantname})
      : super(key: key);

  @override
  _AlarmManagementState createState() => _AlarmManagementState();
}

class _AlarmManagementState extends State<AlarmManagement> {
  ...
  Future loadCollectorDevicesStatusQuery() async {
    ...
    final data = await PlantWarningQuery(SN: widget.SN, devtype: _selectedalldevices_coverted, level: _selectedalltypes_converted, handle: _selectedallstatus_converted, PID: widget.PID!, Sdate: StartDate, Edate: EndDate);
  ...
  Widget buildWarningList(QueryPlantWarning psinfo, double width, double height) {
    setState(() {
      date.text = AppLocalizations.of(context)!.total_alarms_heading;
    });
            ...
            subtitle: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          AppLocalizations.of(context)!.device_pn,
                          style: TextStyle(
                              fontSize: 0.025 * (height - width),
                              color: Colors.grey.shade900),
                        ),
                    ...
                    Row(
                      children: [
                        Text(
                          AppLocalizations.of(context)!.device_type,
                          style: TextStyle(
                              fontSize: 0.025 * (height - width),
                              color: Colors.grey.shade900),
                        ),
                ...
                Column(
                  children: [
                    Text(
                        '${(PSINFO.handle == true) ? AppLocalizations.of(context)!.processed : AppLocalizations.of(context)!.untreated}',
                        style: TextStyle(
                          fontSize: 0.03 * (height - width),
                          fontWeight: FontWeight.bold,
                          color:
